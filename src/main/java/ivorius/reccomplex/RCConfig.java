...
public class RCConfig
{
    ...
    public static void loadConfig(String configID)
    {
        ...
        if (configID == null || configID.equals(CATEGORY_BALANCING))
        {
            ...
            disablingsomeloggings = RecurrentComplex.config.getBoolean("disablingsomeloggings", CATEGORY_CONTROLS, false, "Enabling this will disable some loggings like (registered/replaced and more)");
